...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            $sql = "SELECT * FROM products WHERE details = 'iphone'";
            ...
            ?>
                ...
                <form  method="POST" action="products.php" >
                    <div class="card d-flex justify-content-start" style="width: 19.5rem;height:390px">
    ...
    <h2><i><ion-icon name="game-controller-outline"></ion-icon> Laptop Gaming</i></h2> 
    <div class="container">
        <div class="row">
            <?php
            require("config/config.php");
            $sql = "SELECT * FROM products WHERE details = 'laptop'";
            $query = mysqli_query($conn,$sql);
            while($row = mysqli_fetch_array($query)){
            ?>
                <div class="col-lg-3 mx-0 my-3" >
    ...
    <h2><i><ion-icon name="headset-outline"></ion-icon> Audio</i></h2> 
    <div class="container ">
        <div class="row ">
            <?php
            require("config/config.php");
            $sql = "SELECT * FROM products WHERE details = 'media'";
            $query = mysqli_query($conn,$sql);
            while($row = mysqli_fetch_array($query)){
            ?>
                <div class="col-lg-3 mx-0 my-3" >
                <form  method="POST" action="products.php">
                    <div class="card" style="width: 19.5rem;height:380px">
                    <img src="./assets/images/<?= $row['image'] ?>" style="width:200px;height:200px" class="card-img-top h-100" alt="">
                    <div class="card-body">
                        <h5 class="card-title "><?= $row['name'] ?></h5>
                        <p class="card-text ">$<?= $row['price'] ?></p>
